<?php
  ...
  // $current_question = $questions[$start] ?? null;
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['answer']) && isset($_POST['question_id'])) {
    ...
    if ($page < $total_questions) {
      ...
      foreach ($_SESSION['answers'] as $question_id => $answer) {
        $insert = mysqli_query($conn, "INSERT INTO user_responses_tbl (user_id, test_session_id, question_id, answer)
        VALUES('$user_id', '$test_session_id', '$question_id', '$answer')");
        ...
        <div class="container">
          <div class="page-inner quest">
            <div class="text-center container-fluid">
              <!--<img src="../image/OIP.jpg" alt="image" class="image-fluid"/>-->
            </div>
